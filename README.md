...
| [ ![Download](https://api.bintray.com/packages/zhongrui/mylibrary/QRCode/images/download.svg?version=1.0.0) ](https://bintray.com/zhongrui/mylibrary/QRCode/1.0.0/link)| 最新版本号(全格式)|
|--------|----|
```gradle
